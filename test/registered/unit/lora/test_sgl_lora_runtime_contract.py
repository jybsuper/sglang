"""Runtime contracts at the SGL MoE-LoRA policy/runner boundary.

This file intentionally covers only two durable properties:

* every policy runner is admitted against the resident BF16 MoE layout before
  it can execute; and
...
class TestRunnerAdmission:
    """Reject resident states no precreated policy runner can consume."""
